                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                            $default_img_customer = ($customer->gender == 'm') ? "profile-2.png" : "profile-1.png";
                                            $default_img_customer_url = ($customer->photo) ? ( asset("storage/customers/$customer->photo") ) : asset("storage/profile/demo/$default_img_customer");
                                        ?>
                                        <img class="img-fluid-customer" src="{{ $default_img_customer_url }}" />
                                    </td>
                                    <td>{{ $customer->name }}</td>
